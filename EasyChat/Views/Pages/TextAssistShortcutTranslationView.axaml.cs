...
public partial class TextAssistShortcutTranslationView : UserControl
{
    ...
    public TextAssistShortcutTranslationView()
    {
    ...
    private void OnTextBoxPropertyChanged(object? sender, AvaloniaPropertyChangedEventArgs e)
    {
        if (e.Property == TextBox.SelectionStartProperty || e.Property == TextBox.SelectionEndProperty)
            Dispatcher.UIThread.Post(UpdateSelectionButtons);
    }
    ...
    private static async System.Threading.Tasks.Task OpenSelectionAsync(
        TextAssistTranslationViewModel vm, TextBox box, bool result = false)
    {
