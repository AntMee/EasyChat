...
try {
    ...
    $statements = @(
        ...
        'INSERT INTO `Control` (`Dialog_`, `Control`, `Type`, `X`, `Y`, `Width`, `Height`, `Attributes`, `Property`, `Text`, `Control_Next`, `Help`) VALUES (''InstallDirDlg'', ''InstallDirEdit'', ''PathEdit'', 25, 84, 264, 18, 3, ''INSTALLFOLDER'', '''', ''Browse'', '''')',
        ...
        'INSERT INTO `ControlEvent` (`Dialog_`, `Control_`, `Event`, `Argument`, `Condition`, `Ordering`) VALUES (''InstallDirDlg'', ''Browse'', ''[_BrowseProperty]'', ''INSTALLFOLDER'', ''1'', 1)',
        ...
        'INSERT INTO `ControlEvent` (`Dialog_`, `Control_`, `Event`, `Argument`, `Condition`, `Ordering`) VALUES (''InstallDirDlg'', ''Next'', ''SetTargetPath'', ''INSTALLFOLDER'', ''1'', 1)',
        'INSERT INTO `ControlEvent` (`Dialog_`, `Control_`, `Event`, `Argument`, `Condition`, `Ordering`) VALUES (''InstallDirDlg'', ''Next'', ''DoAction'', ''RustValidatePath'', ''NOT WIXUI_DONTVALIDATEPATH'', 2)',
        'INSERT INTO `ControlEvent` (`Dialog_`, `Control_`, `Event`, `Argument`, `Condition`, `Ordering`) VALUES (''InstallDirDlg'', ''Next'', ''SpawnDialog'', ''InvalidDirDlg'', ''NOT WIXUI_DONTVALIDATEPATH AND WIXUI_INSTALLDIR_VALID<>"1"'', 3)',
        'INSERT INTO `ControlEvent` (`Dialog_`, `Control_`, `Event`, `Argument`, `Condition`, `Ordering`) VALUES (''InstallDirDlg'', ''Next'', ''NewDialog'', ''VerifyReadyDlg'', ''WIXUI_DONTVALIDATEPATH OR WIXUI_INSTALLDIR_VALID="1"'', 4)',
        ...
        'INSERT INTO `ControlEvent` (`Dialog_`, `Control_`, `Event`, `Argument`, `Condition`, `Ordering`) VALUES (''BrowseDlg'', ''OK'', ''NewDialog'', ''InstallDirDlg'', ''WIXUI_DONTVALIDATEPATH OR WIXUI_INSTALLDIR_VALID="1"'', 5)',
