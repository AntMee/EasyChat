...
{
    ValueTask<OperationResult<CapabilityStatus>> RequestAsync(
...
{
    ValueTask<OperationResult<EncodedImage>> CaptureAsync(
...
public interface IGlobalHotkeyRegistrar
{
    ...
    ValueTask<OperationResult<bool>> RegisterAsync(
...
{
    ValueTask<OperationResult<SelectedText>> CaptureAsync(
...
{
    ValueTask<OperationResult<bool>> DeliverAsync(
...
{
    ValueTask<OperationResult<string?>> ReadTextAsync(CancellationToken cancellationToken = default);

    ValueTask<OperationResult<bool>> WriteTextAsync(
        string text,
        CancellationToken cancellationToken = default);
}
...
{
    ValueTask<OperationResult<ExternalTargetToken>> GetActiveTargetAsync(
        CancellationToken cancellationToken = default);

    ValueTask<OperationResult<bool>> ActivateAsync(
        ExternalTargetToken target,
        CancellationToken cancellationToken = default);
}
