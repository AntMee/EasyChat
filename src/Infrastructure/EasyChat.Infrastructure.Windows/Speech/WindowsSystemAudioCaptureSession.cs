...
internal sealed class WindowsSystemAudioCaptureSession : IWindowsPcmCaptureSession
{
    ...
    public WindowsSystemAudioCaptureSession(PcmAudioFormat targetFormat)
    {
    ...
    private void OnRecordingStopped(object? sender, StoppedEventArgs args)
    {
        ...
        Failed?.Invoke(args.Exception ?? new InvalidOperationException(
            "Windows system audio capture stopped unexpectedly."));
    }
    ...
    private static WaveFormat NormalizeWaveFormat(WaveFormat format)
    {
        ...
        throw new NotSupportedException($"Unsupported WASAPI loopback format: {format}.");
    }
